    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div>
        ...
        <input
          ...
          @input="emit('update:filterDestination', $event.target.value)"
          type="text"
      ...
      <div>
        ...
        <div class="flex space-x-2">
          <input
            ...
            @input="emit('update:filterStartDate', $event.target.value)"
            type="date"
      ...
      <div>
        ...
        <div class="flex space-x-2">
          <input
            ...
            @input="emit('update:filterCreatedStartDate', $event.target.value)"
            type="date"
            placeholder="Data início"
            class="w-1/2 border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            ...
            @input="emit('update:filterCreatedEndDate', $event.target.value)"
            type="date"
            placeholder="Data fim"
            class="w-1/2 border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
